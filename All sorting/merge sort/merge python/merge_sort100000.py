...
# Random Numbers
random_case = random.sample(range(1, 200001), n)
...
temp = partial_case[50000:]
random.shuffle(temp)
partial_case[50000:] = temp

# Missing Numbers
missing_case = random.sample(range(1, 150001), n)

# Duplicates
duplicate_case = [random.randint(1, 1000) for _ in range(n)]
